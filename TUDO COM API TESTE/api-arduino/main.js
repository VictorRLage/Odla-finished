    ...
    arduino.pipe(new serialport.ReadlineParser({ delimiter: '\r\n' })).on('data', async (data) => {
        ...
        if (HABILITAR_OPERACAO_INSERIR) {
            ...
            if (AMBIENTE == 'producao') {
                ...
                sqlquery = `INSERT INTO [dbo].[VerificacaoHora] (dataHora, Lux, fkSensor) VALUES (CURRENT_TIMESTAMP, ${luminosidade}, 1)`;

                // CREDENCIAIS DO BANCO REMOTO - SQL SERVER
                const connStr = "Server=grupo1acquatec.database.windows.net;Database=Acquatec;User Id=Odlar;Password=Urubu100;";
